...
int main(int argc, char *argv[])
{
  ...
  auto most_sleepy_guard_sum = 0;
  auto most_sleepy_guard_most_sleepy_minute = 0;
  auto most_sleepy_guard_most_sleepy_slept = 0;
  for (auto [guard, sum] : guard_sleep_minutes) {
    if (sum > most_sleepy_guard_sum) {
      most_sleepy_guard = guard;
      most_sleepy_guard_sum = sum;
      most_sleepy_guard_most_sleepy_slept = 0;
